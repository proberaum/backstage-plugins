// Copied from Remix Icons https://remixicon.com/icon/file-settings-line
// under Remix Icon License v1.0.
//
// All Remix Icons are free to use for personal and commercial projects.
//
// For full terms, please refer to the Remix Icon License v1.0.
